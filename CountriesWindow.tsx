...
export function CountriesWindow({ children, onClose }: WindowProps) {
  return (
    <>
      ...
      <div className="animate-fade-down animate-duration-[1000ms] animate-ease-out w-[500px] rounded absolute bg-gray-900 p-5 left-96">
        ...
        <h1 className="text-center text-white text-2xl mb-5 font-mono">Transfer to another country</h1>
